...
import TopFertilizerInputData from "../../pages/systemManager/DataInsertGraphs/TopFertilizerInputData"
    ...
    const submitHandler = async (e) => {
        ...
        if (!isNaN(parseInt(name.trim()))) {
            ...
            try {
                ...
                const response = await axios.post(`${API_URL}/topfertilizercategory/add`, {
                    fertilizername: name,
                    noofsales: sales
                });
